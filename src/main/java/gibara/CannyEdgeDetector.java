...
public class CannyEdgeDetector {
	...
	public final static Logger LOG = Logger.getLogger(CannyEdgeDetector.class);
	// statics
	...
	private final static int MAXLEVELS = 9999;
	private static String outputDirName = "./output";
	...
	private void follow(int x1, int y1, int i1, int threshold, int level) {
		if (level++ > MAXLEVELS ) {
			LOG.debug("max levels in follow("+MAXLEVELS+") exceeded");
			return;
		}
